                ...
                {!isSuccess ? (
                  ...
                  >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                      <div>
                        <label htmlFor="form-name" className="text-sm text-gray-400 mb-2 block">Ваше имя</label>
                        <input 
                          id="form-name"
                          type="text" 
                          required
                      ...
                      <div>
                        <label htmlFor="form-contact" className="text-sm text-gray-400 mb-2 block">Контакты (Телефон или Telegram)</label>
                        <input 
                          id="form-contact"
                          type="text" 
                          required
                      ...
                      <div>
                        <label htmlFor="form-message" className="text-sm text-gray-400 mb-2 block">Какую задачу нужно решить?</label>
                        <textarea 
                          id="form-message"
                          rows={4} 
                          required
